...
class Calendar
{
    ...
    private function num_month_range(DateTime $dt_start, DateTime $dt_end)
    {
        ...
        {
            array_push($this->_month_names, $dt_mod->format("F"));
            $num_month++;
    ...
    public function draw_header($start_at, $end_at, $name, $events)
    {
        ...
        echo "<td height=\"150\" style=\"-webkit-transform: rotate(90deg); -moz-transform: rotate(90deg); -o-transform: rotate(90deg); writing-mode: tb-rl;\" rowspan=\"3\"><center>" . $name ."</td>\n";
        ...
        while($tmp_date->format("Y-m-d") <= $end_date->format("Y-m-d"))
        {
            ...
            {
                echo "<td class=\"cellClass\" bgcolor=\"". $td_bg_color .
                     "\" width=\"20\" height=\"100\">";
            }
            else
            {
                echo "<td class=\"cellClass\" width=\"20\" height=\"100\">";
            }
            ...
            foreach($events as $event)
            {
                if ($event->_start_date == $tmp_date->format("Y-m-d"))
                {
                    echo "<div style='font-size: 0.3em;font-family: Arial;float:left;'>".
                         "<a href=\"#\"><img src=\"indicator_transp.png\"".
        ...
        while($tmp_date2->format("Y-m-d") <= $end_date->format("Y-m-d"))
        {
            ...
            {
                echo "<td width=\"60\" bgcolor=\"". $td_bg_color ."\" height=\"20\">\n";
            }
            else
            {
